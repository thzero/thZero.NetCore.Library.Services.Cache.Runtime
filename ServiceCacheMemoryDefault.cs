...
{
    public sealed class ServiceCacheMemoryDefault : ServiceCacheMemoryDefaultBase<ServiceCacheMemoryDefault>
    {
        public ServiceCacheMemoryDefault(ILogger<ServiceCacheMemoryDefault> logger) : base(null, logger)
        {
        }
    }

    public sealed class ServiceCacheMemoryDefaultFactory : ServiceCacheMemoryDefaultBase<ServiceCacheMemoryDefaultFactory>
    {
        ...
        public ServiceCacheMemoryDefaultFactory() : base(log, null)
        {
        }
    }

    // http://stackoverflow.com/questions/4183270/how-to-clear-the-net-4-memorycache/22388943#comment34789210_22388943
    public abstract class ServiceCacheMemoryDefaultBase<TService> : ServiceCacheBaseMemory<TService>
    {
        public ServiceCacheMemoryDefaultBase(thZero.Services.IServiceLog log, ILogger<TService> logger) : base(log, logger)
        {
        }
