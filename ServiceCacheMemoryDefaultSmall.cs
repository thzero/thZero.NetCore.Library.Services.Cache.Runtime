...
{
    public sealed class ServiceCacheMemoryDefaultSmall : ServiceCacheMemoryDefaultBaseSmall<ServiceCacheMemoryDefaultSmall>
    {
        public ServiceCacheMemoryDefaultSmall(ILogger<ServiceCacheMemoryDefaultSmall> logger) : base(null, logger)
        {
        }
    }

    public sealed class ServiceCacheMemoryDefaultFactorySmall : ServiceCacheMemoryDefaultBaseSmall<ServiceCacheMemoryDefaultFactorySmall>
    {
        ...
        public ServiceCacheMemoryDefaultFactorySmall() : base(log, null)
        {
        }
    }

    // http://stackoverflow.com/questions/4183270/how-to-clear-the-net-4-memorycache/22388943#comment34789210_22388943
    public abstract class ServiceCacheMemoryDefaultBaseSmall<TService> : ServiceCacheBaseMemory<TService>
    {
        public ServiceCacheMemoryDefaultBaseSmall(thZero.Services.IServiceLog log, ILogger<TService> logger) : base(log, logger)
        {
        }
